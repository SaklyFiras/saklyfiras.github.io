...
export interface IFindProjectProps {}

export default function ProjectComp(props: IFindProjectProps) {
	const { title } = useParams();
	const project = findProject(title as string);
	...
	return (
		<div className="mt-36">
			...
			<div className=" flex flex-row justify-between  flex-wrap  gap-4    p-4">
				<div className="flex flex-col  items-start sm:w-[60%] indent-2 ">
